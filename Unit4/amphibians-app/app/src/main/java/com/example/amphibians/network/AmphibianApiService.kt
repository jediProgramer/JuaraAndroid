...
/**
 * Build the Moshi object with Kotlin adapter factory
 * that Retrofit will be using to parse JSON
 */
...
interface AmphibianApiService {
    /**
     * Declare a suspended function to get the [List] of [Amphibian]
     * and this method can be called from a Coroutine
     */
